...
console.log("✅ Chaves geradas e salvas como 'private_key.pem' e 'public_key.pem'.");
...
console.log("✅ Chaves convertidas para Base64 e salvas como 'private_key_base64.txt' e 'public_key_base64.txt'.");
